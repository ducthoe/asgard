...
_DOWNLOAD_RANGE_SIZE = 16 * 1024 * 1024
_DOWNLOAD_INITIAL_WORKERS = 4
_DOWNLOAD_MAX_WORKERS = 16
_DOWNLOAD_TUNE_INTERVAL_S = 2.0
_DOWNLOAD_TUNE_COOLDOWN_S = 8.0
_HASH_CHUNK_SIZE = 4 * 1024 * 1024
_HASH_PARALLEL_MIN_SIZE = 8 * 1024 * 1024
